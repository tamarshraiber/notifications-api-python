...
from models import Notification, SENT, FAILED, RETRY_PENDING, PENDING, PROCESSING
    ...
    def send_one(self, n):
        ...
        for target in n.target_channels:
            ...
            if result == "Success":
                ...
                n.last_error = response.get("Message")
                return
    ...
    def send_one(self, n):
        ...
        for target in n.target_channels:
            ...
            if channel_type == "email":
                ...
                final_status = FAILED
                last_error = f"Unknown channel: {channel_type}"
                break
