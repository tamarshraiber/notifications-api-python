...
### Architecture:
I divided the project into clear layers so that the code would be more readable, clear, understandable and easy to expand:
...
`processor` – responsible for sending messages  
